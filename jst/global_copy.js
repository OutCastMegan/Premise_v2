...
Global = {
  ...
  checkScreenWidth: function() {
    ...
    else if (Global.storiesVisible != 4 && Global.isMobile()){
      Global.storiesVisible = 4;
      Global.updateGrid();
    }

    else if (Global.storiesVisible != 2 && Global.isMobile2()){
  ...
  isMobile: function(){
    ...
    return (width <= 750 && width > 490);
  },
  isMobile2: function(){
    return ($(window).width() <= 490);
  }
};
